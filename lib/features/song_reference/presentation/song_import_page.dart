...
class SongImportPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final automaticAvailable = ref.watch(
      songSeparatorProvider.select(
        (separator) => separator.automaticSeparationAvailable,
      ),
    );
    final busy = state.status == SongReferenceStatus.separating;
    return Scaffold(

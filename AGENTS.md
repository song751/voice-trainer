...
`P3-00` through `P3-06`, checkpoint card `P3-07P`, and evidence-contract card
`P3-07A` are accepted and complete. `P3-07` remains incomplete and has ordered
subcards in `docs/PHASE3_TASKS.md`. The **only** card now allowed is `P3-07B`,
which adds gate-only production-pipeline performance observation; do not begin
`P3-07C` until `P3-07B` is accepted and recorded.

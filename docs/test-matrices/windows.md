...
| Fake/P4-12/reference集成闭环 | CI：`Windows build` actual-target integrations | 候选`c89ce5d`本地通过；hosted候选Pending | fake 6/6、P4-12 route 1/1、reference extraction/comparison/playback 1/1；不计入真实麦克风或扬声器听感覆盖。 |

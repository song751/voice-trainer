...
| P4-13 release seal | CI + local equivalent-server validator | 最终候选本地通过；hosted CI Pending | 候选`c89ce5d`的28个关键资产（含NOTICE）、8个WASM通过release hash、no-store、MIME、CSP和本地CanvasKit；P4-09/P4-10/P4-11 Edge gates均重跑通过。不是P4-15真实浏览器/麦克风证据。 |
